    ...
    const fetchAllData = async () => {
      try {
        ...
        const [
          ...
          axios.get(
            "https://congozi-backend.onrender.com/api/v1/users/last-week",
            config
          ),
          axios.get(
            "https://congozi-backend.onrender.com/api/v1/users/current-week",
            config
          ),
          axios.get(
            "https://congozi-backend.onrender.com/api/v1/exams/last-week",
            config
          ),
          axios.get(
            "https://congozi-backend.onrender.com/api/v1/exams/current-week",
            config
          ),
          axios.get(
            "https://congozi-backend.onrender.com/api/v1/accounts/last-week",
            config
          ),
          axios.get(
            "https://congozi-backend.onrender.com/api/v1/accounts/current-week",
            config
          ),
        ]);
